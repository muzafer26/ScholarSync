  ...
  return (
    ...
    >
      <div className="page-container flex h-16 items-center justify-between">
        ...
        >
          <div className="relative h-7 w-7 rounded-sm bg-primary flex items-center justify-center shadow-[inset_0_1px_2px_rgba(255,255,255,0.3)] border border-primary/20 transition-transform group-hover:scale-105">
            <span className="text-primary-foreground font-mono font-bold text-[14px] leading-none">S</span>
          </div>
          <span className="font-serif font-bold text-[22px] leading-none tracking-tight text-foreground">ScholarSync</span>
        </Link>
