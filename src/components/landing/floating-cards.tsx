...
const CARDS = [
  ...
  { icon: GraduationCap, title: "Rhodes Scholarship", meta: "Oxford · Fully Funded",   tone: "bg-amber-500/10 text-amber-600 dark:text-amber-400",        r: -3, x: -22, y: 12 },
  { icon: Briefcase,   title: "Google Summer Intern", meta: "Internship · Remote",     tone: "bg-sky-500/10 text-sky-600 dark:text-sky-400",              r: 6,  x: 12,  y: 20 },
      ...
      <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 z-10">
        <div className="relative">
          ...
          <div className="relative surface px-4 py-3 rounded-2xl flex items-center gap-2.5">
            ...
            <span className="font-serif text-base">Sage</span>
            <span className="text-[11px] text-muted-foreground font-mono">// thinking…</span>
          </div>
        </div>
      </div>
